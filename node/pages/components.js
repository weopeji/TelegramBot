...
async function acceptProject(socket,data,callback) 
{
    ...
    var html = `[Профиль компании](${h.getURL()}html/profil/#${_project._id})\n[Презентация](${getURL()}/projects/${_project._id}/${_project.data["file+7"]})\n[Видео презентация](${getURL()}/projects/${_project._id}/${_project.data["file+8"]})`;
