...
async function startFunMore(msg)
{
    ...
    html            += "\n\nПерешлите вашу индивидуальную ссылку БИЗНЕСУ на добавление нового проекта. Если проект окажется перспективным и на встрече с собственниками проекта нам все понравится, проект будет размещен на investER, закреплен за ВАМИ и вы получите от 0,5% до 1% с привлеченных в проект средств на нашей платформе.";
