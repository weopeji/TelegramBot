    ...
    function Main()
    {
        ...
        function acceptingButtons(_id) 
        {
            ...
            $('.not_accept').click( function() 
            {
                ...
                _components.preloader("Заявка отправлена на доработку", "Будет расположена в разделе На исправлении", 'Проект ожидает изменений! Внесите правки в разделе "Неактивные проекты"');
            });
        }
