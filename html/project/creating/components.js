            ...
            this.struct = 
            {
                ...
                "+4": {
                    ...
                    body: [
                        {
                            type: "file",
                            name: "Загрузите скан паспорта всех учередителей юр. лица, все страницы одним файлом в формате PDF по каждому лицу отдельно",
                            _id: "file+4"
                        },
                    ]
                },
                ...
                "+8": {
                    ...
                    body: [
                        {
                            type: "file",
                            name: `Загрузите вашу видео-презентацию, елси она есть`,
                            _id: "file+8"
                        },
                    ]
                }
